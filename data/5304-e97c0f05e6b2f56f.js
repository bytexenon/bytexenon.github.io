                    ...
                    function t(e, r) {
                      ...
                      if (
                        ...
                        O(this, "pauseFor", function (e) {
                          return g.addEventToQueue(f, { ms: e }), g;
                        }),
                        ...
                        O(this, "callFunction", function (e, t) {
                          ...
                          return g.addEventToQueue(p, { cb: e, thisArg: t }), g;
                        }),
                        ...
                        O(this, "addEventToStateProperty", function (e, t) {
                          ...
                          return (
                            (g.state[n] = r
                              ? [o].concat(x(g.state[n]))
                              : [].concat(x(g.state[n]), [o])),
                            g
                          );
                        }),
                              ...
                              switch (
                                ...
                                case s:
                                  ...
                                  g.options.onCreateTextNode &&
                                    ...
                                    (T = g.options.onCreateTextNode(O, E)),
                                    T &&
                                      (S
                                        ? S.appendChild(T)
                                ...
                                case p:
                                  var M = a.eventArgs,
                                    P = M.cb,
                                    C = M.thisArg;
                                  P.call(C, { elements: g.state.elements });
                                  break;
                                case d:
                                  var D = a.eventArgs,
                                    k = D.node,
                                      ...
                                      [
                                        {
                                          ...
                                          node: k,
                                          parentNode:
                                            N || g.state.elements.wrapper,
                                        },
                                      ]
                                    ));
                                  break;
                                case c:
                                  var F = g.state.visibleNodes,
                                    W = j.speed,
                                    L = [];
                                  W &&
                                    L.push({
                ...
                2492: (e, t, r) => {
                  ...
                  e.exports = function (e, t, r, v, y, m) {
                    ...
                    if (O && !x)
                      return (
                        m || (m = new n()),
                        b || l(e) ? o(e, t, r, v, y, m) : a(e, t, w, r, v, y, m)
                      );
                    if (!(1 & r)) {
                    ...
                    return !!O && (m || (m = new n()), i(e, t, r, v, y, m));
                  };
                },
                8458: (e, t, r) => {
                  var n = r(3560),
                  ...
                  e.exports = function (e, t, r, i, s, u) {
                    ...
                    for (u.set(e, t), u.set(t, e); ++h < l; ) {
                      var m = e[h],
                        b = t[h];
                      if (i)
                        var g = c ? i(b, m, h, t, e, u) : i(m, b, h, e, t, u);
                      if (void 0 !== g) {
                        if (g) continue;
                        v = !1;
                        break;
                  ...
                  e.exports = function (e, t, r, a, i, s) {
                    ...
                    for (var y = u; ++f < l; ) {
                      var m = e[(p = c[f])],
                        b = t[p];
                      if (a)
                        var g = u ? a(b, m, p, t, e, s) : a(m, b, p, e, t, s);
                      if (!(void 0 === g ? m === b || i(m, b, r, a, s) : g)) {
                        v = !1;
                        break;
                      }
                      y || (y = "constructor" == p);
      ...
      function v(e, t) {
        ...
        return (function (e, t, r) {
          ...
          let w =
            ...
            _ = Math.round((w - (h(v) - h(f)) / 1e3) / 60);
          if (_ < 2) {
            if (null == r ? void 0 : r.includeSeconds) {
              if (w < 5) return m.formatDistance("lessThanXSeconds", 5, g);
              if (w < 10) return m.formatDistance("lessThanXSeconds", 10, g);
              if (w < 20) return m.formatDistance("lessThanXSeconds", 20, g);
              if (w < 40) return m.formatDistance("halfAMinute", 0, g);
              else if (w < 60)
                return m.formatDistance("lessThanXMinutes", 1, g);
              else return m.formatDistance("xMinutes", 1, g);
            }
            return 0 === _
              ? m.formatDistance("lessThanXMinutes", 1, g)
              : m.formatDistance("xMinutes", _, g);
          }
          if (_ < 45) return m.formatDistance("xMinutes", _, g);
          if (_ < 90) return m.formatDistance("aboutXHours", 1, g);
          if (_ < 1440)
            return m.formatDistance("aboutXHours", Math.round(_ / 60), g);
          if (_ < 2520) return m.formatDistance("xDays", 1, g);
          if (_ < 43200)
            return m.formatDistance("xDays", Math.round(_ / 1440), g);
          if (_ < 86400)
            return (
              (y = Math.round(_ / 43200)),
          ...
          if (
            ...
            return m.formatDistance("xMonths", Math.round(_ / 43200), g);
          {
            let e = y % 12,
              t = Math.trunc(y / 12);
            return e < 3
              ? m.formatDistance("aboutXYears", t, g)
              : e < 9
              ? m.formatDistance("overXYears", t, g)
              : m.formatDistance("almostXYears", t + 1, g);
          }
        })(
          e,
          ((r = Date.now()),
