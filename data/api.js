...
(function () {
  ...
  function tt(e, r) {
    return (
      ...
      Object.getOwnPropertyDescriptors
        ...
        : Rr(Object(r)).forEach(function (a) {
  ...
  function De(e, r) {
    var a = {
      ...
      g;
    return (
      (g = { next: f(0), throw: f(1), return: f(2) }),
  ...
  var wt = function (e) {
      var r,
        ...
        p = L(
          Nr,
          (f =
            (a = e.displayLanguage) === null || a === void 0
              ? void 0
              : a.toLowerCase()) !== null && f !== void 0
            ? f
            : "nonexistent"
        );
      return o
  ...
  function sr() {
    ...
    var r = { loadedAsync: !1, params: new URLSearchParams() };
  ...
  var Rt = function (e, r) {
      var a = Et(r.params, !1),
        ...
        l,
        g = ""
          .concat(a, "/cdn-cgi/challenge-platform/")
      ...
      (x.id = e + "-fr"),
        ...
        x.setAttribute("allow", "cross-origin-isolated; fullscreen"),
        x.setAttribute(
          "sandbox",
  ...
  function fr(e) {
    ...
    var r = function (a, o) {
      ...
      for (var c = 1, l = a.previousElementSibling; l; )
        l.tagName === a.tagName && c++, (l = l.previousElementSibling);
    ...
    if (typeof e != "string")
      throw new Error(
        "djb2: expected string, got ".concat(
          typeof e == "undefined" ? "undefined" : P(e)
        )
      );
  ...
  function gr(e, r) {
    ...
    return a
      ? ((r.isReady = a.isReady),
        (r.isRecaptchaCompatibilityMode = a.isRecaptchaCompatibilityMode),
        (r.lastWidgetIdx = a.lastWidgetIdx),
        (r.scriptWasLoadedAsync = a.scriptWasLoadedAsync),
        (r.upgradeAttempts = a.upgradeAttempts),
        (r.upgradeCompletedCount = a.upgradeCompletedCount + 1),
        (r.turnstileLoadInitTimeMs = W()),
        (r.watchCatInterval = null),
        (r.watchCatSeq = a.watchCatSeq),
        (r.widgetMap = a.widgetMap),
        !0)
      : !1;
  }
  var Lr = 900,
      ...
      for (
        ...
        if (!(p.isComplete || p.isFailed)) {
          ...
          (s = T.contentWindow) === null ||
            s === void 0 ||
            s.postMessage(
              { source: V, widgetId: f, seq: e.watchCatSeq, event: "meow" },
              "*"
            );
        }
      }
  ...
  function kt() {
    var e = [$t, Jt];
    y.isRecaptchaCompatibilityMode && e.push(Zt),
  ...
  function Pr(e) {
    ...
    if (!(r === void 0 || r.hasResponseParamEl)) {
      ...
      var a,
        o = (a = r.params["response-field"]) !== null && a !== void 0 ? a : !0;
      if (o) {
        ...
        if (
          ...
          xr((g = r.params.sitekey) !== null && g !== void 0 ? g : "")
        ) {
  ...
  function Er(e, r) {
    ...
    if (
      (o !== null && U(o, HTMLInputElement) && (o.value = r),
  ...
  var Lt = (function () {
    var e = function (n, i, t, d) {
        ...
        if (n.params.retry === fe.AUTO || t) {
          ...
          var d,
            u = t
              ? 0
              : 1e3 * 2 +
                ((d = n.params["retry-interval"]) !== null && d !== void 0
                  ? d
                  : 0);
      ...
      a = function (n, i, t) {
        ...
        n.response === void 0 &&
          ...
          (d = n.cbSuccess) === null ||
            d === void 0 ||
            d.call(n, n.response, t);
      },
      o = function (n) {
        if (!n) return [];
        for (
          var i = n.attributes, t = i.length, d = new Array(t), u = 0;
          u < t;
          u++
        )
          d[u] = i[u].name;
      ...
      g = function (n) {
        ...
        try {
          for (
            var u = y.widgetMap[Symbol.iterator](), h;
            !(i = (h = u.next()).done);
            i = !0
          ) {
            var E = Ae(h.value, 2),
      ...
      f = function (n, i, t) {
        for (; n.msgQueue.length; ) {
          ...
          (d = t.contentWindow) === null ||
            d === void 0 ||
            d.postMessage({ source: V, widgetId: i, event: u }, "*");
        }
      },
      p = function (n, i) {
        if (i) {
      ...
      s = function (n) {
        ...
        if (t) {
          ...
          (!d || !u) &&
            m("Widget ".concat(i, " to reset was not found."), 3330),
            t.params.appearance === X.INTERACTION_ONLY && yr(u),
      ...
      x = function (n) {
        ...
        h == null ||
          h.shadow.querySelectorAll(u.join(", ")).forEach(function (w) {
            return w.remove();
          }),
      ...
      T = function (n, i) {
        ...
        if (typeof n == "string")
          try {
            ...
            E || m('Unable to find a container for "'.concat(n, '"'), 3585),
              (h = E);
          } catch (Ut) {
            m(
        ...
        if (D) {
          ...
          v["retry-interval"] = Number(
            (ae = v["retry-interval"]) !== null && ae !== void 0 ? ae : er
          );
          var ye;
          ...
          typeof B != "string" &&
            m(
              'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                typeof B == "undefined" ? "undefined" : P(B),
                '"'
              ),
              3588
            ),
          ...
          dt(Q)
            ...
            : m(
                'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                  .concat(Q, '" ')
                  .concat(typeof Q == "undefined" ? "undefined" : P(Q)),
                3603
              );
          var Te,
            ne =
          ...
          if (!(!Re || !de)) {
            ...
            Qe || m("Turnstile Initialization Error ", 3606),
              (j.style.display = "none"),
              (j.style.border = "none"),
              (j.style.overflow = "hidden"),
              j.setAttribute("src", xt(Re, B, v, Y, !1, "g", gt(Qe))),
              (j.onerror = function () {
                if (G) {
            ...
            L(
              ...
              (j.id = de);
            var Je;
            (j.tabIndex = (Je = v.tabindex) !== null && Je !== void 0 ? Je : 0),
              (j.title = "Widget containing a Cloudflare security challenge"),
              Ft.appendChild(j);
            var Ze,
              Tr =
                (Ze = v["response-field"]) !== null && Ze !== void 0 ? Ze : !0;
            if (Tr) {
              ...
              if (
                ((Ne.name =
                  (et = v["response-field-name"]) !== null && et !== void 0
                    ? et
                    : yt),
                (Ne.id = "".concat(de, "_response")),
                se.appendChild(Ne),
                typeof v["response-field-name"] != "string" && xr(B))
              ) {
      ...
      N = function () {
        ...
        try {
          for (
            var h = y.widgetMap[Symbol.iterator](), E;
            !(t = (E = h.next()).done);
            t = !0
          ) {
            var w = Ae(E.value, 2),
    ...
    function I() {
      return (
        (I = Wt(function (_, n, i, t) {
          var d, u, h, E, w, A, S, F, H, Z;
          return De(this, function (D) {
            switch (D.label) {
              case 0:
                if (((d = _.params.sitekey), (u = _r()), !u))
                  return (
                    b(
            ...
            switch (n.event) {
              case "init": {
                ...
                h ||
                  ...
                  (d = h.contentWindow) === null ||
                    d === void 0 ||
                    d.postMessage(
                      { source: V, widgetId: n.widgetId, event: "init" },
                      "*"
                    );
                break;
              }
              case "translationInit": {
                ...
                var w = new Map();
                (t.displayLanguage = n.displayLanguage),
                  Object.keys(n.translationData).forEach(function (ne) {
              ...
              case "food": {
                t.watchcat &&
                  n.seq > t.watchcat.lastAckedSeq &&
                  (t.watchcat.lastAckedSeq = n.seq);
                break;
              }
              case "overrunBegin": {
                (t.isOverrunning = !0),
              ...
              case "complete": {
                c(t, Y, n.widgetId),
                  (t.response = n.token),
                  n.sToken ? e(t, i, n.sToken, n.chlId) : a(t, i, !1);
                break;
              }
              case "fail": {
                n.rcV && c(t, n.rcV, n.widgetId),
                  n.cfChlOut && (t.cfChlOut = n.cfChlOut),
                  n.cfChlOutS && (t.cfChlOutS = n.cfChlOutS),
                  n.code && (t.errorCode = n.code),
                  (t.isExecuting = !1),
                  (t.isFailed = !0),
                  (t.isInitialized = !0),
                  Ot(i);
                ...
                if (H) {
                  ...
                  D == null ||
                    ...
                    Z === void 0 ||
                    Z.postMessage(
                      { source: V, widgetId: n.widgetId, event: "forceFail" },
                      "*"
                    );
                }
                if (F) {
                  var v;
                  F(String((v = n.code) !== null && v !== void 0 ? v : Gt))
                    ? t.params.retry === fe.AUTO && !t.isResetting && r(t, i, H)
                    : (n.code && b("Error: ".concat(n.code, ".")), r(t, i, H));
                } else
                  n.code
                    ? (r(t, i, H), m("Error: ".concat(n.code), 3076))
                    : r(t, i, !1);
                break;
              }
              case "feedbackInit": {
              ...
              case "interactiveBegin": {
                ...
                Ce ||
                  ...
                  (be = t.cbBeforeInteractive) === null ||
                    be === void 0 ||
                    be.call(t),
                  t.params.appearance === X.INTERACTION_ONLY && Ct(Ce, t);
                break;
              }
              case "interactiveEnd": {
                var Ee;
    ...
    return tt(Fe({}, M), {
          ...
          typeof n != "function" &&
            m(
              'turnstile.ready() expected a "function" argument, got "'.concat(
                typeof n == "undefined" ? "undefined" : P(n),
                '"'
              ),
              3841
            ),
      ...
      execute: function (n, i) {
        ...
        if (u) {
          ...
          if (
            ...
            return;
          if (
            (u.isInitialized && f(u, t, w),
            u.isInitialized && u.params.appearance === X.EXECUTE && Ct(w, u),
            u.isExecuting)
          ) {
            var A,
              S = u.shadow.querySelector("#".concat(h));
            S || m("Received state for an unknown widget: ".concat(t), 3078),
              (A = S.contentWindow) === null ||
                A === void 0 ||
                A.postMessage(
                  { source: V, widgetId: t, event: "execute" },
                  "*"
                );
          }
        }
      ...
      getResponse: function (n) {
        ...
        return (
          ...
          (i = y.widgetMap.get(h)) === null || i === void 0
            ? void 0
            : i.response
        );
      },
  ...
  function Wr(e) {
    ...
    i
      ? (Yt(i) ||
        ...
        (a["feedback-enabled"] = i === "true"))
      : (a["feedback-enabled"] = !0);
    var t,
      d =
  ...
  function Hr() {
    ...
    It(y, e),
      ...
      mr(window.turnstile, y);
  }
  (ve = !1),
    (C = sr()),
    (y.scriptWasLoadedAsync =
      (ze = C == null ? void 0 : C.loadedAsync) !== null && ze !== void 0
        ? ze
        : !1),
    C != null &&
      C.params &&
      ((me = C.params.get("compat")),
    ...
    Nt && !ve
      ...
      : (Nt &&
          ...
          St(y),
          (C == null || (Ge = C.params) === null || Ge === void 0
            ? void 0
            : Ge.get("render")) !== "explicit" && setTimeout(kt, 0)),
        (window.turnstile = Lt),
        ve ||
          ((C == null || (Xe = C.params) === null || Xe === void 0
            ? void 0
            : Xe.get("render")) !== "explicit" && Mt.push(kt),
          document.readyState === "complete" ||
          document.readyState === "interactive"
            ? setTimeout(hr, 0)
            : window.addEventListener("DOMContentLoaded", hr))),
    (br = 24 * 60 * 60 * 1e3),
    window.setTimeout(Hr, br);
